...
def get_hf_metadata(hf_repo, hf_token):
    ...
    except (AttributeError, requests.exceptions.RequestException, json.JSONDecodeError, \
            huggingface_hub.errors.RepositoryNotFoundError, huggingface_hub.utils.HfHubHTTPError) as e:
...
def get_hf_context_window(hf_repo, hf_token):
    ...
    try:
        ...
        return None
    except (Exception, huggingface_hub.errors.RepositoryNotFoundError, huggingface_hub.utils.HfHubHTTPError) as e:
    ...
    with Progress(
        ...
        for row in rows:
            ...
            if row["context_window"] is None:
                ...
                if "context_window" not in update_fields and row["hf_repo"] and row["hf_repo"] != '':
